...
class Reporter:
    ...
    def __init__(self, config: Any, db_path: str, state_manager: Any) -> None:
    ...
    def run(self, shutdown_event: Any) -> None:
        ...
        while not shutdown_event.is_set():
            try:
                ...
                sleep_time = max(
                    0, self._config.monitoring.report_interval_seconds - elapsed
                )
    ...
    def _run_cycle(self) -> None:
        ...
        # Assemble output
        output = {"generated_at": now, "consumers": consumers}
    ...
    def _process_consumer(
        self, group_id: str, topic: str, partitions: List[int], now: int
