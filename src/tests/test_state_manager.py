...
class TestStateManager:
    ...
    def test_init_loads_preexisting_group_statuses(self, db_path_initialized):
        ...
        try:
            database.upsert_group_status(
                conn, "group1", "topic1", "ONLINE", 1000, 900, 0
            )
            database.upsert_group_status(
                conn, "group2", "topic2", "OFFLINE", 2000, 1500, 5
            )
            database.upsert_group_status(
    ...
    def test_get_group_status_unknown_returns_default_online(self, db_path_initialized):
    ...
    def test_set_group_status_updates_in_memory(self, db_path_initialized):
    ...
    def test_set_group_status_persists_to_database(self, db_path_initialized):
        ...
        conn = database.get_connection(db_path_initialized)
        try:
            db_status = database.get_group_status(conn, "group1", "topic1")
        finally:
            conn.close()
    ...
    def test_get_group_status_returns_copy(self, db_path_initialized):
    ...
    def test_get_all_group_statuses_returns_copy(self, db_path_initialized):
    ...
    def test_update_and_get_thread_last_run(self, db_path_initialized):
    ...
    def test_set_and_get_last_json_output(self, db_path_initialized):
        ...
        output = {
            "timestamp": 1000,
            "consumers": [{"group_id": "group1", "lag_seconds": 60}],
        }
    ...
    def test_concurrent_access_no_data_corruption(self, db_path_initialized):
    ...
    def test_status_update_overwrites_previous(self, db_path_initialized):
